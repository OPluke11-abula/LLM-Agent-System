...
def test_api_route_inventory():
    ...
    expected_routes = {
        ...
        '/v1/audit/proof/{event_id}', '/v1/audit/verify-proof',
        '/v1/audit/forensics/{session_id}', '/v1/audit/forensics/{session_id}/export', '/v1/health',
        '/health', '/api/version', '/v1/version',
