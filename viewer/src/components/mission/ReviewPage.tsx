...
export function ReviewPage() {
  ...
  const gateRows = (mission.required_verification ?? []).map((gate) => {
    ...
    return { gate, record, refs, linkedEvidence, pass, resolved: pass || notApplicable, typesCompatible };
  });
